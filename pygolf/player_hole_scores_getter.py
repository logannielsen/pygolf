...
def player_data_getter(event_id, player_id, session): 
    ...
    print(json_data)
# work on getting individual holes out of data. 
# Issue appears to be with hitting event number 1 as it has no players. Need to build something into bypass these events.
